 ...
 * 문제점
 * 학생정보의 td 가 여러개 있는데 어떤 td를 클릭해도
 * 같은 코드가 실행되도록 하려면
 * 모든 td에 dataset을 설정해야 한다
...
document.addEventListener("DOMContentLoaded", () => {
  const st_table = document.querySelector("table.student.list");
  /*
  ...
  알아내서 연산을 수행할 것이다
  */
  st_table?.addEventListener("click", tdClickHandlerV2);
});
