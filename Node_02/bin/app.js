...
// rootRouter(routes/root.js)에게 전달하기
app.use("/", rootRouter);
// http://localhost:3000/user 로 요청이 들어오면
// userRouter(routes/user.js)에게 전달하기
app.use("/user", userRouter);

// http://localhost:3000/user 에서
// 3000까지는 nodejs가 받고 그 뒤부터는 express가 받음

// app.js 에서 생성한 module 을
// 다른 module 에서 import 하여 사용할수 있도록 내보내기
// 모듈은 꼭 마지막에 이게 나와야한다
export default app;
